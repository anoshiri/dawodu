<x-app :title="'Articles'">
	...
	<div class="inner_table">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="bridcrumb">	<a href="/">Home</a> / Articles</div>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="col-md-6 col-lg-8">
					<div class="businerss_news">
						<div class="row">
							...
							<div class="col-12">
								@if (isset($param))
									<p>Displaying results {{ $articles->currentPage()*$articles->perPage() - $articles->perPage() + 1 }}-{{ $articles->currentPage()*$articles->perPage() - $articles->perPage() + $articles->count() }} out of {{ $articles->total() }} for <strong>{{ $param }}</strong></p>
								@endif
