...
class GovernmentSiteController extends Controller
{
    ...
    {
        $sites = SiteLink::orderBy('title')->isGovernmentSite()->isActive()->paginate(10);

        return view('government_sites', compact('sites'));
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('government_sites', compact('sites', 'param'));
    }
}
